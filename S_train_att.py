...
train_dataset_path  =  'data/all/21beach/21_data.npy'
train_labels_path = 'data/all/21beach/21_label.npy'
train_dataset_path1  =  'data/all/21beach/augmented21_data.npy'
train_labels_path1 = 'data/all/21beach/augmented21_label.npy'


val_dataset_path = 'data/all/21_all/21_alldata.npy'
val_labels_path = 'data/all/21_all/21_alllabel.npy'
...
def load_train_data():
    ...
    train_dataset_rw1 = load_npy(train_dataset_path1).astype('float32')
    train_dataset_rw = np.concatenate((train_dataset_rw1, train_dataset_rw), axis=0)
    print('训练集数据形状：',train_dataset_rw.shape)
    train_target_rw = load_npy(train_labels_path).astype('float32')
    train_target_rw1 = load_npy(train_labels_path1).astype('float32')
    train_target_rw = np.concatenate((train_target_rw1, train_target_rw), axis=0)
...
torch.save(models[model_name]['model'].state_dict(),'Mymodel_Attention(S3).pth')